...
public class ViewportUtils {
    ...
    public static void drawGrid(Viewport viewport, ShapeRenderer renderer, int cellSize) {
        if (viewport == null) throw new IllegalArgumentException("viewport param is required");
        if (renderer == null) throw new IllegalArgumentException("renderer param is required");
